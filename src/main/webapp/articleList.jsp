		...
		<div class="col-md-9">
			...
			<div style="text-align: center;">
					<nav aria-label="Page navigation">
						<ul class="pagination">
						  <li><a href="${pageContext.request.contextPath}/article/foreground/list?pn=1">首页</a></li>
						  <c:if test="${pageInfo.hasPreviousPage}">
						  	<li>
						      <a href="${pageContext.request.contextPath}/article/foreground/list?pn=${pageInfo.pageNum - 1}" aria-label="Previous">
					      ...
					      <c:forEach items="${pageInfo.navigatepageNums}" var="page_Num">
					    	...
					    	<c:if test="${page_Num != pageInfo.pageNum}">
						    	<li><a href="${pageContext.request.contextPath}/article/foreground/list?pn=${page_Num}">${page_Num}</a></li>
					    	</c:if>
					      </c:forEach>
					      <c:if test="${pageInfo.hasNextPage}">
						    <li>
						      <a href="${pageContext.request.contextPath}/article/foreground/list?pn=${pageInfo.pageNum + 1}" aria-label="Next">
						        <span aria-hidden="true">下一页</span>
						      </a>
						    </li>
					      </c:if>
						    <li><a href="${pageContext.request.contextPath}/article/foreground/list?pn=${pageInfo.pages}">尾页</a></li>
						  </ul>
					</nav>
				</div>
